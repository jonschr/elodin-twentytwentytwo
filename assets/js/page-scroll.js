jQuery(document).ready(function ($) {
    ...
    function setSectionAnimation(sectionOffset, windowHeight, animationName) {
        ...
        if (sectionOffset >= -windowHeight && sectionOffset <= 0) {
            ...
            switch (animationName) {
                ...
                case 'catch':
                    if (
                        ...
                        translateY =
                            (-(10 / 7.5) * sectionOffset * 100) / windowHeight;
                        boxShadowBlur =
            ...
            switch (animationName) {
                case 'scaleDown':
                    scale = (1 - (sectionOffset * 0.3) / windowHeight).toFixed(
                        5
                    );
...
//none
jQuery.Velocity.RegisterEffect('translateUp', {
    defaultDuration: 1,
    calls: [[{ translateY: '-100%' }, 1]],
});
jQuery.Velocity.RegisterEffect('translateDown', {
    defaultDuration: 1,
    calls: [[{ translateY: '100%' }, 1]],
});
jQuery.Velocity.RegisterEffect('translateNone', {
    defaultDuration: 1,
    calls: [
        [
            {
...
//rotation
jQuery.Velocity.RegisterEffect('rotation', {
    defaultDuration: 1,
    calls: [[{ opacity: '0', rotateX: '90', translateY: '-100%' }, 1]],
});
jQuery.Velocity.RegisterEffect('rotation.scroll', {
    defaultDuration: 1,
