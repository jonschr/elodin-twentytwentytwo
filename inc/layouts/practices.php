...
//* Output practices before
// add_action( 'before_loop_layout_practices', 'elodin_practices_before' );
function elodin_practices_before( $args ) {
	// wp_enqueue_script( 'SCRIPTHANDLE' );
}

//* Output each practices
add_action( 'add_loop_layout_practices', 'elodin_practices_each' );
function elodin_practices_each() {
